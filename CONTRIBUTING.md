# Contributing to LlamaCrates

Thank you for your interest in contributing to LlamaCrates! This document provides guidelines and instructions for contributing to this project.
...
There are many ways to contribute to LlamaCrates:
...
2. **Clone your fork**:
   ```bash
   git clone https://github.com/YOUR_USERNAME/llamacrates.git
   cd llamacrates
   ```

3. **Set up the upstream remote**:
   ```bash
   git remote add upstream https://github.com/llamasearchai/llamacrates.git
   ```
...
By contributing to LlamaCrates, you agree that your contributions will be licensed under the project's MIT License.
